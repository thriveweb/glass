			...
			<div className='container'>
				<div className='post-container'>
					<ul class="share-buttons">
						...
						<li><a href="https://www.facebook.com/sharer/sharer.php?u=&quote=" target="_blank" title="Share on Facebook"><ICONFacebook/></a></li>
						<li><a href="https://twitter.com/intent/tweet?source=&text=:%20" target="_blank" title="Tweet"><ICONTwitter/></a></li>
						<li><a href="http://www.linkedin.com/shareArticle?mini=true&url=&title=&summary=&source=" target="_blank" title="Share on LinkedIn"><ICONLinkedin/></a></li>
					</ul>
